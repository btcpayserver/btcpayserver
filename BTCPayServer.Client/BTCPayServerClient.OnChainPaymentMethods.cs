...
public partial class BTCPayServerClient
{
    ...
    {
        return await SendHttpRequest<UpdatePaymentMethodRequest, OnChainPaymentMethodPreviewResultData>($"api/v1/stores/{storeId}/payment-methods/{paymentMethodId}/onchain/preview",
    ...
    public virtual async Task<OnChainPaymentMethodPreviewResultData> PreviewStoreOnChainPaymentMethodAddresses(
        ...
        CancellationToken token = default)
    {
        return await SendHttpRequest<OnChainPaymentMethodPreviewResultData>($"api/v1/stores/{storeId}/payment-methods/{paymentMethodId}/onchain/preview",
    ...
    public virtual async Task<GenerateOnChainWalletResponse> GenerateOnChainWallet(string storeId,
        ...
        CancellationToken token = default)
    {
        return await SendHttpRequest<GenerateOnChainWalletResponse>($"api/v1/stores/{storeId}/payment-methods/{paymentMethodId}/onchain/generate", request, HttpMethod.Post, token);
    }

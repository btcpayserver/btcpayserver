...
public partial class BTCPayServerClient
{
    public virtual async Task<OnChainWalletObjectData> GetOnChainWalletObject(string storeId, string cryptoCode, OnChainWalletObjectId objectId, bool? includeNeighbourData = null, CancellationToken token = default)
    {
        ...
        try
        {
            return await SendHttpRequest<OnChainWalletObjectData>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/objects/{objectId.Type}/{objectId.Id}", parameters, HttpMethod.Get, token);
        }
    ...
    public virtual async Task<OnChainWalletObjectData[]> GetOnChainWalletObjects(string storeId, string cryptoCode, GetWalletObjectsRequest query = null, CancellationToken token = default)
    {
        ...
        if (query?.IncludeNeighbourData is bool v)
            parameters.Add("includeNeighbourData", v);
        return await SendHttpRequest<OnChainWalletObjectData[]>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/objects", parameters, HttpMethod.Get, token);
    }
    ...
    {
        await SendHttpRequest($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/objects/{objectId.Type}/{objectId.Id}", null, HttpMethod.Delete, token);
    }
    public virtual async Task<OnChainWalletObjectData> AddOrUpdateOnChainWalletObject(string storeId, string cryptoCode, AddOnChainWalletObjectRequest request,
        CancellationToken token = default)
    {
        return await SendHttpRequest<OnChainWalletObjectData>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/objects", request, HttpMethod.Post, token);
    }
    ...
    public virtual async Task AddOrUpdateOnChainWalletLink(string storeId, string cryptoCode,
        ...
        CancellationToken token = default)
    {
        await SendHttpRequest($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/objects/{objectId.Type}/{objectId.Id}/links", request, HttpMethod.Post, token);
    }
    ...
    public virtual async Task RemoveOnChainWalletLinks(string storeId, string cryptoCode,
        ...
        CancellationToken token = default)
    {
        await SendHttpRequest($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/objects/{objectId.Type}/{objectId.Id}/links/{link.Type}/{link.Id}", null, HttpMethod.Delete, token);
    }
}

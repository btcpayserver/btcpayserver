...
public partial class BTCPayServerClient
{
    ...
    {
        return await SendHttpRequest<OnChainWalletOverviewData>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet", null, HttpMethod.Get, token);
    }
        ...
        CancellationToken token = default)
    {
        ...
        return await SendHttpRequest<OnChainWalletFeeRateData>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/feerate", queryParams, HttpMethod.Get, token);
    }
    ...
    public virtual async Task<OnChainWalletAddressData> GetOnChainWalletReceiveAddress(string storeId, string cryptoCode, bool forceGenerate = false,
        CancellationToken token = default)
    {
        return await SendHttpRequest<OnChainWalletAddressData>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/address", new Dictionary<string, object>
        {
    ...
    public virtual async Task UnReserveOnChainWalletReceiveAddress(string storeId, string cryptoCode,
        CancellationToken token = default)
    {
        await SendHttpRequest($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/address", null, HttpMethod.Delete, token);
    }
        ...
        CancellationToken token = default)
    {
        ...
        return await SendHttpRequest<IEnumerable<OnChainWalletTransactionData>>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/transactions", query, HttpMethod.Get, token);
    }
    ...
    public virtual async Task<OnChainWalletTransactionData> GetOnChainWalletTransaction(
        ...
        CancellationToken token = default)
    {
        return await SendHttpRequest<OnChainWalletTransactionData>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/transactions/{transactionId}", null, HttpMethod.Get, token);
    }
    ...
    {
        return await SendHttpRequest<PatchOnChainTransactionRequest, OnChainWalletTransactionData>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/transactions/{transactionId}", 
    ...
    public virtual async Task<IEnumerable<OnChainWalletUTXOData>> GetOnChainWalletUTXOs(string storeId,
        ...
        CancellationToken token = default)
    {
        return await SendHttpRequest<IEnumerable<OnChainWalletUTXOData>>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/utxos", null, HttpMethod.Get, token);
    }
        ...
        CancellationToken token = default)
    {
        ...
        return await SendHttpRequest<OnChainWalletTransactionData>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/transactions", request, HttpMethod.Post, token);
    }
        ...
        CancellationToken token = default)
    {
        ...
        return Transaction.Parse(await SendHttpRequest<string>($"api/v1/stores/{storeId}/payment-methods/{cryptoCode}-CHAIN/onchain/wallet/transactions", request, HttpMethod.Post, token), network);
    }
}

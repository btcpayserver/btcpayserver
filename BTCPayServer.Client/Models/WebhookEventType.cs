...
public static class WebhookEventType
{
    ...
    public const string SubscriptionMemberActivated = nameof(SubscriptionMemberActivated);
    public const string SubscriptionMemberDisabled = nameof(SubscriptionMemberDisabled);

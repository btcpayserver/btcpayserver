...
namespace BTCPayServer
{
    ...
    {
        public BTCPayNetworkBase[] InitLiquidAssets(NBXplorerNetworkProvider nbXplorerNetworkProvider)
        {
            ...
            return new[]
            {
                new ElementsBTCPayNetwork()
                {
                    ...
                    BlockExplorerLink =
                        nbXplorerNetworkProvider.NetworkType == NetworkType.Mainnet
                            ? "https://blockstream.info/liquid/tx/{0}"
                            : "https://blockstream.info/testnet/liquid/tx/{0}",
                    NBXplorerNetwork = nbxplorerNetwork,
                    UriScheme = "liquidnetwork",
                    CryptoImagePath = "imlegacy/liquid-tether.svg",
                    DefaultSettings =
                        BTCPayDefaultSettings.GetDefaultSettings(nbXplorerNetworkProvider.NetworkType),
                ...
                new ElementsBTCPayNetwork()
                {
                    ...
                    ShowSyncSummary = false,
                    DefaultRateRules =
                        new[] {"LCAD_CAD = 1", "LCAD_X = CAD_BTC * BTC_X", "LCAD_BTC = bylls(CAD_BTC)",},

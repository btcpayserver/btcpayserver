...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTCPayServer.Data.WalletLabelData", b =>
                {
                    ...
                    b.HasKey("WalletDataId", "Label");

                    b.ToTable("WalletLabels");
                });

            modelBuilder.Entity("BTCPayServer.Data.WalletScriptData", b =>
                {
                    b.Property<string>("WalletDataId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("WalletLabelDataWalletScriptData", b =>
                {
                    b.Property<string>("WalletLabelsWalletDataId")
                        .HasColumnType("TEXT");

                    b.Property<string>("WalletLabelsLabel")
                        .HasColumnType("TEXT");

                    b.Property<string>("WalletScriptsWalletDataId")
                        .HasColumnType("TEXT");

                    b.Property<string>("WalletScriptsScript")
                        .HasColumnType("TEXT");

                    b.HasKey("WalletLabelsWalletDataId", "WalletLabelsLabel", "WalletScriptsWalletDataId", "WalletScriptsScript");

                    b.HasIndex("WalletScriptsWalletDataId", "WalletScriptsScript");

                    b.ToTable("WalletLabelDataWalletScriptData");
                });

            modelBuilder.Entity("WalletLabelDataWalletTransactionData", b =>
                {
                    b.Property<string>("WalletLabelsWalletDataId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("WalletTransactionsWalletDataId")
                        .HasColumnType("TEXT");

                    b.Property<string>("WalletTransactionsTransactionId")
                        .HasColumnType("TEXT");

                    b.HasKey("WalletLabelsWalletDataId", "WalletLabelsLabel", "WalletTransactionsWalletDataId", "WalletTransactionsTransactionId");

                    b.HasIndex("WalletTransactionsWalletDataId", "WalletTransactionsTransactionId");

                    b.ToTable("WalletLabelDataWalletTransactionData");
                });

            modelBuilder.Entity("WalletScriptDataWalletTransactionData", b =>
                {
                    b.Property<string>("WalletScriptsWalletDataId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("WalletScriptsWalletDataId", "WalletScriptsScript", "WalletTransactionsWalletDataId", "WalletTransactionsTransactionId");

                    b.HasIndex("WalletTransactionsWalletDataId", "WalletTransactionsTransactionId");

                    b.ToTable("WalletScriptDataWalletTransactionData");
                });
            ...
            modelBuilder.Entity("WalletLabelDataWalletScriptData", b =>
                {
                    b.HasOne("BTCPayServer.Data.WalletLabelData", null)
                        .WithMany()
                        .HasForeignKey("WalletLabelsWalletDataId", "WalletLabelsLabel")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BTCPayServer.Data.WalletScriptData", null)
                        .WithMany()
                        .HasForeignKey("WalletScriptsWalletDataId", "WalletScriptsScript")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WalletLabelDataWalletTransactionData", b =>
                {
                    ...
                    b.HasOne("BTCPayServer.Data.WalletTransactionData", null)
                        .WithMany()
                        .HasForeignKey("WalletTransactionsWalletDataId", "WalletTransactionsTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

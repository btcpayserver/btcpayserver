...
namespace BTCPayServer.Migrations
{
    ...
    public partial class subs : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "subscriptions_plan_changes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_subscriptions_plan_changes", x => new { x.plan_id, x.plan_change_id });
                    table.ForeignKey(
                        name: "FK_subscriptions_plan_changes_subscriptions_plans_plan_change_~",
                        column: x => x.plan_change_id,
                        principalTable: "subscriptions_plans",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_subscriptions_plan_changes_subscriptions_plans_plan_id",
                        column: x => x.plan_id,
                        principalTable: "subscriptions_plans",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_subscriptions_subscribers_subscriptions_plans_new_plan_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_subscriber_invoices_subscriptions_subscribers_subscriber_id",
            ...
            migrationBuilder.CreateTable(
                name: "subscriptions_subscriber_credits",
                columns: table => new
                {
                    subscriber_id = table.Column<long>(type: "bigint", nullable: false),
                    currency = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_subscriptions_subscriber_credits", x => new { x.subscriber_id, x.currency });
                    table.ForeignKey(
                        name: "FK_subscriptions_subscriber_credits_subscriptions_subscribers_~",
                        column: x => x.subscriber_id,
                        principalTable: "subscriptions_subscribers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "subscriptions_subscriber_credits_history",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    subscriber_id = table.Column<long>(type: "bigint", nullable: false),
                    currency = table.Column<string>(type: "text", nullable: false),
                    created_date = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_subscriptions_subscriber_credits_history", x => x.Id);
                    table.ForeignKey(
                        name: "FK_subscriptions_subscriber_credits_history_subscriptions_subs~",
                        columns: x => new { x.subscriber_id, x.currency },
                        principalTable: "subscriptions_subscriber_credits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subscriptions_plan_changes_plan_change_id",
                table: "subscriptions_plan_changes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subscriptions_subscriber_credits_history_subscriber_id_crea~",
                table: "subscriptions_subscriber_credits_history",
                columns: new[] { "subscriber_id", "created_date" },
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "IX_subscriptions_subscriber_credits_history_subscriber_id_curr~",
                table: "subscriptions_subscriber_credits_history",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subscriptions_subscribers_new_plan_id",
                table: "subscriptions_subscribers",
                column: "new_plan_id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_email_rules_subscriptions_offerings_offering_id",
                table: "email_rules",
                column: "offering_id",
                principalTable: "subscriptions_offerings",
                principalColumn: "id",

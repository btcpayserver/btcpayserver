...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTCPayServer.Data.WalletObjectData", b =>
                {
                    ...
                    b.HasKey("WalletId", "ObjectTypeId", "ObjectId");

                    b.ToTable("WalletObjects");
                });

            modelBuilder.Entity("BTCPayServer.Data.WalletTaintData", b =>
                {
                    b.Property<string>("WalletId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("TaintTypeId")
                        .HasColumnType("TEXT");

                    b.Property<string>("TaintId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("Stickiness")
                        .HasColumnType("INTEGER");

                    b.HasKey("WalletId", "ObjectTypeId", "ObjectId", "TaintTypeId", "TaintId");

                    b.HasIndex("WalletId", "LabelId");

                    b.ToTable("WalletTaints");
                });
            ...
            modelBuilder.Entity("BTCPayServer.Data.WalletTaintData", b =>
                {
                    b.HasOne("BTCPayServer.Data.WalletLabelData", "Label")
                        .WithMany("Taints")
                        .HasForeignKey("WalletId", "LabelId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BTCPayServer.Data.WalletObjectData", "WalletObject")
                        .WithMany("Taints")
                        .HasForeignKey("WalletId", "ObjectTypeId", "ObjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Label");

                    b.Navigation("WalletObject");
                });

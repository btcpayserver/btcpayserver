...
namespace BTCPayServer.Services.Rates
{
    ...
    public class RateFetcher
    {
        ...
        public async Task<RateResult> FetchRate(CurrencyPair pair, RateRules rules,string context, CancellationToken cancellationToken)
        {
            return await FetchRates(new HashSet<CurrencyPair>(new[] { pair }), rules,context, cancellationToken).First().Value;
        }

        public Dictionary<CurrencyPair, Task<RateResult>> FetchRates(HashSet<CurrencyPair> pairs, RateRules rules, string context, CancellationToken cancellationToken)
        {
        ...
        public Task<RateResult> FetchRate(RateRule rateRule,string context, CancellationToken cancellationToken)
        {

...
#pragma warning disable CS0618
        ...
        public void CanParseDerivationScheme()
        {
            ...
            var testnetParser = new DerivationSchemeParser(testnetNetworkProvider.GetNetwork<BitcoinSpecificBTCPayNetwork>("BTC"));
            var mainnetParser = new DerivationSchemeParser(mainnetNetworkProvider.GetNetwork<BitcoinSpecificBTCPayNetwork>("BTC"));
            ...
            var regtestParser = new DerivationSchemeParser(regtestNetworkProvider.GetNetwork<BitcoinSpecificBTCPayNetwork>("BTC"));
            ...
            regtestParser = new DerivationSchemeParser(regtestNetworkProvider.GetNetwork<BitcoinSpecificBTCPayNetwork>("DOGE"));
        ...
        public void CanAddDerivationSchemes()
        {
            using (var tester = ServerTester.Create())
            {
                ...
                var btcNetwork = tester.PayTester.Networks.GetNetwork<BitcoinSpecificBTCPayNetwork>("BTC");
                var invoice = user.BitPay.CreateInvoice(new Invoice()
                {
                    Price = 1.5m,
                    Currency = "USD",
...
";
        ...
        {
            var mainnet = new BTCPayNetworkProvider(NetworkType.Mainnet).GetNetwork<BitcoinSpecificBTCPayNetwork>("BTC");
            ...
            var testnet = new BTCPayNetworkProvider(NetworkType.Testnet).GetNetwork<BitcoinSpecificBTCPayNetwork>("BTC");

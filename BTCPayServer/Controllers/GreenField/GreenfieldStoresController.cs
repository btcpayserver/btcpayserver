    ...
    public class GreenfieldStoresController : ControllerBase
    {
        ...
        internal async Task<Client.Models.StoreData> FromModel(StoreData data)
        {
            ...
            return new Client.Models.StoreData
            {
                ...
                AdditionalTrackedCurrencies = (storeBlob.AdditionalTrackedCurrencies ?? []).ToList(),
        ...
        private void ToModel(StoreBaseData restModel, StoreData model)
        {
            ...
            blob.AdditionalTrackedCurrencies = restModel.AdditionalTrackedCurrencies?.ToArray();

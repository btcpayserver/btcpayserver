        ...
        public class AddApiKeyViewModel
        {
            ...
            public class PermissionValueItem
            {
                public static readonly Dictionary<string, (string Title, string Description)> PermissionDescriptions = new Dictionary<string, (string Title, string Description)>()
                {
                    ...
                    {BTCPayServer.Client.Policies.CanUpdateInvoice, ("Update invoices", "The app will be able to update invoices.")},
                    {$"{BTCPayServer.Client.Policies.CanUpdateInvoice}:", ("Update invoices", "The app will be able to update invoices on the selected stores.")},
                    {BTCPayServer.Client.Policies.CanArchiveInvoice, ("Archive invoices", "The app will be able to archive and unarchive invoices.")},
                    {$"{BTCPayServer.Client.Policies.CanArchiveInvoice}:", ("Archive invoices", "The app will be able to archive and unarchive invoices on the selected stores.")},
                    {BTCPayServer.Client.Policies.CanUpdateInvoiceStatus, ("Update invoice status", "The app will be able to update the status of invoices.")},
                    {$"{BTCPayServer.Client.Policies.CanUpdateInvoiceStatus}:", ("Update invoice status", "The app will be able to update the status of invoices on the selected stores.")},

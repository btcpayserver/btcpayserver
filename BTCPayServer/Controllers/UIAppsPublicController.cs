            ...
            try
            {
                var invoice = await _InvoiceController.CreateInvoiceCore(new BitpayCreateInvoiceRequest()
                {
                    ...
                    RedirectURL = !string.IsNullOrEmpty(redirectUrl) ? redirectUrl
                                : !string.IsNullOrEmpty(settings.RedirectUrl) ? settings.RedirectUrl: null,
                    ...
                    {
                        entity.Metadata.OrderUrl = !string.IsNullOrEmpty(redirectUrl) ? redirectUrl
        ...
        public async Task<IActionResult> ContributeToCrowdfund(string appId, ContributeToCrowdfund request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var invoice = await _InvoiceController.CreateInvoiceCore(new BitpayCreateInvoiceRequest()
                    ...
                    cancellationToken, (entity) =>
                    {
                        entity.Metadata.OrderUrl = HttpContext.Request.GetAbsoluteUri($"/apps/{appId}/crowdfund");
                    });

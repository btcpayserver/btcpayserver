        ...
        public class AddApiKeyViewModel
        {
            ...
            public class PermissionValueItem
            {
                public static readonly Dictionary<string, (string Title, string Description)> PermissionDescriptions = new Dictionary<string, (string Title, string Description)>()
                {
                    ...
                    {Policies.CanManageWallets, ("Manage wallets", "Allows managing wallets on all your stores, including wallet settings and transactions.")},
                    {$"{Policies.CanManageWallets}:", ("Manage selected stores' wallets", "Allows managing wallets on the selected stores, including wallet settings and transactions.")},
                    {Policies.CanModifyBitcoinOnchain, ("Modify Bitcoin on-chain wallets", "Allows access to Bitcoin on-chain wallets on all your stores.")},
                    {$"{Policies.CanModifyBitcoinOnchain}:", ("Modify selected stores' Bitcoin on-chain wallets", "Allows access to Bitcoin on-chain wallets on the selected stores.")},
                    {Policies.CanModifyBitcoinLightning, ("Modify Bitcoin Lightning wallets", "Allows access to Bitcoin Lightning wallets on all your stores.")},
                    {$"{Policies.CanModifyBitcoinLightning}:", ("Modify selected stores' Bitcoin Lightning wallets", "Allows access to Bitcoin Lightning wallets on the selected stores.")},
                    {Policies.CanModifyOtherWallets, ("Modify other wallets", "Allows access to non-Bitcoin wallets on all your stores.")},
                    {$"{Policies.CanModifyOtherWallets}:", ("Modify selected stores' other wallets", "Allows access to non-Bitcoin wallets on the selected stores.")},
                    {Policies.CanViewWallet, ("View wallets", "Allows viewing wallets, balances, and transactions.")},
                    {$"{Policies.CanViewWallet}:", ("View selected stores' wallets", "Allows viewing wallets, balances, and transactions on the selected stores.")},
                    {Policies.CanManageWalletSettings, ("Manage wallet settings", "Allows managing wallet settings and metadata.")},
                    {$"{Policies.CanManageWalletSettings}:", ("Manage selected stores' wallet settings", "Allows managing wallet settings and metadata on the selected stores.")},
                    {Policies.CanManageWalletTransactions, ("Manage wallet transactions", "Allows managing wallet transactions on all your stores.")},
                    {$"{Policies.CanManageWalletTransactions}:", ("Manage selected stores' wallet transactions", "Allows managing wallet transactions on the selected stores.")},
                    {Policies.CanCreateWalletTransactions, ("Create wallet transactions", "Allows creating wallet transactions (PSBTs).")},
                    {$"{Policies.CanCreateWalletTransactions}:", ("Create wallet transactions", "Allows creating wallet transactions (PSBTs) on the selected stores.")},
                    {Policies.CanSignWalletTransactions, ("Sign wallet transactions", "Allows signing wallet transactions (PSBTs).")},
                    {$"{Policies.CanSignWalletTransactions}:", ("Sign wallet transactions", "Allows signing wallet transactions (PSBTs) on the selected stores.")},
                    {Policies.CanBroadcastWalletTransactions, ("Broadcast wallet transactions", "Allows broadcasting wallet transactions.")},
                    {$"{Policies.CanBroadcastWalletTransactions}:", ("Broadcast wallet transactions", "Allows broadcasting wallet transactions on the selected stores.")},
                    {Policies.CanCancelWalletTransactions, ("Cancel wallet transactions", "Allows canceling wallet transactions.")},
                    {$"{Policies.CanCancelWalletTransactions}:", ("Cancel wallet transactions", "Allows canceling wallet transactions on the selected stores.")},

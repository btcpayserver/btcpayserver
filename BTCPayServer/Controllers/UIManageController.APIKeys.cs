        ...
        public class AddApiKeyViewModel
        {
            ...
            public class PermissionValueItem
            {
                public static readonly Dictionary<string, (string Title, string Description)> PermissionDescriptions = new Dictionary<string, (string Title, string Description)>()
                {
                    ...
                    {$"{Policies.CanViewPullPayments}:", ("View your pull payments", "Allows viewing pull payments on the selected stores.")},
                    {Policies.CanViewSubscriptions, ("View your subscriptions", "Allows viewing subscriptions on all your stores.")},
                    {$"{Policies.CanViewSubscriptions}:", ("View your subscriptions", "Allows viewing subscriptions on the selected stores.")},
                    {Policies.CanModifySubscriptions, ("Modify your subscriptions", "Allows modifying subscriptions on all your stores.")},
                    {$"{Policies.CanModifySubscriptions}:", ("Modify your subscriptions", "Allows modifying subscriptions on the selected stores.")},
                    {Policies.CanViewCustomers, ("View your customers", "Allows viewing customers on all your stores.")},
                    {$"{Policies.CanViewCustomers}:", ("View your customers", "Allows viewing customers on the selected stores.")},
                    {Policies.CanModifyCustomers, ("Modify your customers", "Allows modifying customers on all your stores.")},
                    {$"{Policies.CanModifyCustomers}:", ("Modify your customers", "Allows modifying customers on the selected stores.")},

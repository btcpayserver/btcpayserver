        ...
        public class AddApiKeyViewModel
        {
            ...
            public class PermissionValueItem
            {
                public static readonly Dictionary<string, (string Title, string Description)> PermissionDescriptions = new Dictionary<string, (string Title, string Description)>()
                {
                    ...
                    {BTCPayServer.Client.Policies.CanCreateCustodianAccounts, ("Add exchange accounts to your stores", "The app will be able to add an exchange account to all your stores.")},
                    {$"{BTCPayServer.Client.Policies.CanCreateCustodianAccounts}:", ("Add exchange accounts to selected stores", "The app will be able to add an exchange account to selected stores.")},
                    {BTCPayServer.Client.Policies.CanModifyCustodianAccounts, ("Modify exchange accounts linked to your stores", "The app will be able to modify exchange accounts linked to your stores.")},
                    {$"{BTCPayServer.Client.Policies.CanModifyCustodianAccounts}:", ("Modify exchange accounts linked to selected stores", "The app will be able to modify exchange accounts linked to selected stores.")},

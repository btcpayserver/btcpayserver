...
namespace BTCPayServer.Controllers
{
    ...
    public partial class UIServerController : Controller
    {
        ...
        [Route("server/logs")]
        [HttpPost]
        public async Task<IActionResult> LogsSettings(LogsViewModel model, string command)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> LogsView(LogsViewModel model, string command)
        {
            return await LogsSettings(model, command);
        }

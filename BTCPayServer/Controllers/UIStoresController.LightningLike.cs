...
namespace BTCPayServer.Controllers
{
    public partial class UIStoresController
    {
        ...
        public async Task<IActionResult> LightningSettings(LightningSettingsViewModel vm)
        {
            ...
            var lnurl = GetConfig<LNURLPaymentMethodConfig>(new PaymentMethodId(vm.CryptoCode, PaymentTypes.LNURLPay), store);
            if (lnurl is null || (
        ...
        public async Task<IActionResult> SetLightningNodeEnabled(string storeId, string cryptoCode, bool enabled)
        {
            ...
            var lightning = GetConfig<LightningPaymentMethodConfig>(new PaymentMethodId(cryptoCode, PaymentTypes.LightningLike), store);
            if (lightning == null)
                return NotFound();
        ...
        {
            vm.CanUseInternalNode = CanUseInternalLightning(vm.CryptoCode);
            var lightning = GetConfig<LightningPaymentMethodConfig>(new PaymentMethodId(vm.CryptoCode, PaymentTypes.LightningLike), store);

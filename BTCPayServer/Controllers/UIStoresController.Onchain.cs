    ...
    public partial class UIStoresController
    {
        ...
        public async Task<IActionResult> UpdatePaymentSettings(WalletSettingsViewModel vm)
        {
            ...
            if (needUpdate)
            {
                ...
                {
                    var config = store.GetPaymentMethodConfig<DerivationSchemeSettings>(new PaymentMethodId(network.CryptoCode, PaymentTypes.BTCLike), _handlers);
        ...
        public async Task<IActionResult> ConfirmDeleteWallet(string storeId, string cryptoCode)
        {
            ...
            store.SetPaymentMethodConfig(new PaymentMethodId(network.CryptoCode, PaymentTypes.BTCLike), null);
        ...
        {
            return store.GetPaymentMethodConfig<DerivationSchemeSettings>(new PaymentMethodId(cryptoCode, PaymentTypes.BTCLike), _handlers);
        }

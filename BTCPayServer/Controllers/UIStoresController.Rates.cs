...
public partial class UIStoresController
{
    ...
    public IActionResult Rates()
    {
        ...
        vm.Script = storeBlob.GetRateRules(networkProvider).ToString();
        vm.DefaultScript = storeBlob.GetDefaultRateRules(networkProvider).ToString();
    ...
    public async Task<IActionResult> Rates(RatesViewModel model, string? command = null, string? storeId = null, CancellationToken cancellationToken = default)
    {
        ...
        model.DefaultScript = blob.GetDefaultRateRules(networkProvider).ToString();
        ...
        rules = blob.GetRateRules(networkProvider);
        ...
        if (command == "Test")
        {
            ...
            var fetchs = rateFactory.FetchRates(pairs.ToHashSet(), rules, cancellationToken);
    ...
    public async Task<IActionResult> ShowRateRulesPost(bool scripting)
    {
        ...
        blob.RateScript = blob.GetDefaultRateRules(networkProvider).ToString();
    ...
    {
        return rateFactory.RateProviderFactory.AvailableRateProviders

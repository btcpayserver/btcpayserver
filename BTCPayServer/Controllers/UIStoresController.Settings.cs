...
public partial class UIStoresController
{
    ...
    public async Task<IActionResult> GeneralSettings(string storeId)
    {
        ...
        var vm = new GeneralSettingsViewModel
        {
            ...
            AdditionalTrackedCurrency = string.Join(',', storeBlob.AdditionalTrackedCurrencies?.ToArray() ?? []),
        ...
        [FromForm] bool RemoveCssFile = false)
    {
        ...
        blob.AdditionalTrackedCurrencies = model.AdditionalTrackedCurrency?.Split(',', StringSplitOptions.RemoveEmptyEntries);

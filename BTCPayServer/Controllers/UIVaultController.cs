    ...
    public class UIVaultController : Controller
    {
            ...
            WalletId walletId = null)
        {
            ...
            using (var cts = new CancellationTokenSource(TimeSpan.FromMinutes(10)))
            {
                ...
                if (!_handlers.TryGetValue(new PaymentMethodId(cryptoCode, PaymentTypes.BTCLike), out var h) || h is not IHasNetwork { Network: var network })
                    return NotFound();
...
askdevice:
        ...
        {
            var pmi = new PaymentMethodId(walletId.CryptoCode, Payments.PaymentTypes.BTCLike);

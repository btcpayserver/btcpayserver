...
#pragma warning restore CS0618
        ...
        {
            return IsPaymentMethodEnabled(storeData, new PaymentMethodId(cryptoCode, LightningPaymentType.Instance));
        }

        public static bool IsLNUrlEnabled(this StoreData storeData, string cryptoCode)
        {
            return IsPaymentMethodEnabled(storeData, new PaymentMethodId(cryptoCode, LNURLPayPaymentType.Instance));
        }

...
#nullable enable
        ...
        public static string? WalletSettings(this IUrlHelper helper, WalletId walletId) => helper.Action(nameof(UIStoresController.WalletSettings), "UIStores", new { walletId });

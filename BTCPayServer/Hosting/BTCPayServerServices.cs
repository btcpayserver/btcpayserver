...
namespace BTCPayServer.Hosting
{
    public static class BTCPayServerServices
    {
        public static IServiceCollection AddBTCPayServer(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<IPaymentMethodHandler<DerivationSchemeSettings, BitcoinSpecificBTCPayNetwork>>(provider => provider.GetService<BitcoinLikePaymentHandler>());
            ...
            services.AddSingleton<IPaymentMethodHandler<LightningSupportedPaymentMethod, BitcoinSpecificBTCPayNetwork>>(provider => provider.GetService<LightningLikePaymentHandler>());

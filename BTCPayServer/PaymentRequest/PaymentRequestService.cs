    ...
    public class PaymentRequestService
    {
        ...
        public async Task<ViewPaymentRequestViewModel> GetPaymentRequest(string id, string userId = null)
        {
            ...
            return new ViewPaymentRequestViewModel(pr)
            {
                ...
                AmountCollectedFormatted = _currencies.DisplayFormatCurrency(paymentStats.TotalCurrency, blob.Currency),
                AmountDue = amountDue,
                AmountDueFormatted = _currencies.DisplayFormatCurrency(amountDue, blob.Currency),
                ...
                Invoices = new ViewPaymentRequestViewModel.InvoiceList(invoices.Select(entity =>
                {
                    ...
                    var payments = entity
                        ...
                        .Select(paymentEntity =>
                        {
                            ...
                            return new ViewPaymentRequestViewModel.PaymentRequestInvoicePayment
                            {
                                ...
                                PaidFormatted = _currencies.DisplayFormatCurrency(paid, blob.Currency),
                                RateFormatted = _currencies.DisplayFormatCurrency(rate, blob.Currency),
                    ...
                    return new ViewPaymentRequestViewModel.PaymentRequestInvoice
                    {
                        Id = entity.Id,
                        Amount = entity.Price,
                        AmountFormatted = _currencies.DisplayFormatCurrency(entity.Price, blob.Currency),

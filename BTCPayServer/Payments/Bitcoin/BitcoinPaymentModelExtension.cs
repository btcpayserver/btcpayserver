...
namespace BTCPayServer.Payments.Bitcoin
{
    public class BitcoinPaymentModelExtension : IPaymentModelExtension
    {
            ...
            PaymentMethodHandlerDictionary handlers)
        {
            ...
            var lnPmi = new PaymentMethodId(network.CryptoCode, PaymentTypes.LightningLike);
            lnPaymentLinkExtension = paymentLinkExtensions.SingleOrDefault(p => p.PaymentMethodId == lnPmi);
            var lnurlPmi = new PaymentMethodId(network.CryptoCode, PaymentTypes.LNURLPay);
        ...
        public void ModifyPaymentModel(PaymentModelContext context)
        {
            ...
            {
                var lnPmi = new PaymentMethodId(handler.Network.CryptoCode, PaymentTypes.LightningLike);
                ...
                {
                    var lnurlPmi = new PaymentMethodId(handler.Network.CryptoCode, PaymentTypes.LNURLPay);

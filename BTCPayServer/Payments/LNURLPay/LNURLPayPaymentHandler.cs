...
{
    public class LNURLPayPaymentHandler : IPaymentMethodHandler, IHasNetwork
    {
        ...
        public async Task ConfigurePrompt(PaymentMethodContext context)
        {
            ...
            var lightningHandler = (LightningLikePaymentHandler)handlers[new PaymentMethodId(_network.CryptoCode, PaymentTypes.LightningLike)];
            var store = context.Store;
            var lnPmi = new PaymentMethodId(_network.CryptoCode, PaymentTypes.LightningLike);

    ...
    SubscriptionHostedService subsService) : Controller
{
    ...
    public IActionResult RedirectToSubscriberPortal(string portalId)
        => RedirectToAction(nameof(UISubscriberPortalController.SubscriberPortal), "UISubscriberPortal", new { portalSessionId = portalId });

...
public class SubscriptionEvent
{
    ...
    public class SubscriberCharged(SubscriberData subscriber, decimal total, decimal amount, string currency) : SubscriberEvent(subscriber)
    {
        public decimal Total { get; } = total;
        public decimal Amount { get; set; } = amount;
        public string Currency { get; set; } = currency;
        public override string ToString() => $"Subscriber {Subscriber.ToNiceString()} charged (Amount: {Amount} {Currency}, New Total: {Total} {Currency})";
    }
    ...
    public class PlanStarted(SubscriberData subscriber) : SubscriberEvent(subscriber)
    {

...
public class SubscriptionsPlugin : BaseBTCPayServerPlugin
{
    ...
    public override void Execute(IServiceCollection services)
    {
        ...
        services.AddSingleton<SubscriberWebhookProvider>();
        services.AddSingleton<IWebhookProvider>(o => o.GetRequiredService<SubscriberWebhookProvider>());
        services.AddHostedService(o => o.GetRequiredService<SubscriberWebhookProvider>());

...
"""
{
  ...
  "{0} Wallet Settings": "",
  "{0} details": "",
  "{0}-of-{1} {2} · {3}/{4} submitted · {5}": "",
  "{0}-of-{1} {2} · {3}/{4} submitted · {5} · {6}": "",
  "{0}/{1} signer keys submitted": "",
  "@submitLabel": "",
  ...
  "A plugin install is already queued. Confirming will update the queued install to this version.": "",
  ...
  "Account key": "",
  "Account Key": "",
  "Account key (xpub/tpub)": "",
  "Account key path": "",
  "Account settings and navigation moved to the top-right menu, just look up!": "",
  ...
  "An invitation email has not been sent.<br/>You need to share this link with them: <a class='alert-link' href='{0}'>{0}</a>": "",
  ...
  "An unexpected error occurred while registering the security device.": "",
  "Animation": "",
  "Any amount": "",
  ...
  "Authenticator": "",
  "Authenticator code": "",
  "Authenticator disabled successfully.": "",
  ...
  "Browse the invoices": "",
  "Browse the public plugin directory here and install new plugins.": "",
  "Browser connection": "",
  "Browser Redirect": "",
  ...
  "BTCPay Server contributors or Foundation are not liable for any harm, loss, or damage resulting from the installation or use of the plugins. Users assume full responsibility for their installation, use, familiarity with licensing and terms of service and maintenance.": "",
  "BTCPay Server Configurator": "",
  "BTCPay Server currently supports:": "",
  "BTCPay Server could not load the plugin directory.": "",
  "BTCPay Server could not load the plugin panel.": "",
  "BTCPay Server has queued {0}{1} for this plugin.": "",
  "BTCPay Server Registration will redirect to a custom registration page": "",
  "BTCPay Server sends email requests if email is enabled. You can also share this link or QR code with the selected signers.": "",
  ...
  "Bypass monetization for this user": "",
  ...
  "Compatible wallets": "",
  "Complete signer collection before creating the multisig wallet.": "",
  "Completed": "",
  ...
  "Container Name": "",
  "Continue": "",
  "Continue multisig setup in progress": "",
  "Contribute": "",
  "contribution": "",
  "Contribution Amount": "",
  ...
  "Could not fetch the community language manifest. Showing installed languages only (degraded mode).": "",
  ...
  "Currently active!": "",
  "Currently enabled on this server.": "",
  "Custom": "",
  "Custom (Advanced)": "",
  "Custom amount": "",
  "Custom Amount": "",
  ...
  "Default Tax Rate": "",
  "Default translation changed to {0}": "",
  "Default Value": "",
  "Delay": "",
  "Delete": "",
  "DELETE": "",
  ...
  "Demonetize": "",
  "Dependencies": "",
  "Dependencies are not met yet, so BTCPay Server will schedule the install.": "",
  ...
  "Download PSBT file": "",
  "Downloaded language pack is invalid": "",
  ...
  "Extract from BTCPay Server Vault": "",
  ...
  "Fetch signer data from device to continue.": "",
  "Fetch your account key, fingerprint, and key path using BTCPay Server Vault": "",
  "Fetching device...": "",
  ...
  "If some transactions appear in BTCPay Server, but are missing in another wallet, {0}.": "",
  ...
  "Invalidates the current authenticator configuration. Useful if you believe your authenticator settings were compromised or if you want to disable authenticator.": "",
  "Inventory": "",
  ...
  "Leave empty for unlimited. Set to 0 to prevent non-admins from creating any stores. Per-user overrides can be set on the user's edit page.": "",
  "Legacy": "",
  ...
  "Maximum amount:": "",
  "Maximum number of stores non-admins can create": "",
  "Memo": "",
  "Message": "",
  "Metadata": "",
  ...
  "One or more signers no longer have wallet signing permission.": "",
  "Online": "",
  ...
  "Override the server default maximum number of stores for this user. Leave empty to use the server default.": "",
  "Page Size": "",
  "Page Size:": "",
  "Paid": "",
  ...
  "Passkey name (e.g., MacBook Touch ID)": "",
  "Passkeys": "",
  ...
  "Password successfully set.": "",
  "Paste BIP21": "",
  "Paste your account key and optional origin information manually": "",
  "Paste your account key and optional origin information.": "",
  "Path mode": "",
  "Pay": "",
  "Pay Button": "",
  ...
  "Payment to <strong>{0}</strong>": "",
  "Payment to <strong>{0}</strong> for <strong>{1}</strong>": "",
  "Payments": "",
  "Payout Methods": "",
  ...
  "Please provide your account key.": "",
  ...
  "Plugin directory": "",
  "Plugin details": "",
  "Plugins in this store are developed by independent third parties. These plugins have not undergone review by the BTCPay Server team.": "",
  ...
  "Present in the upstream translation repository but not yet on this server.": "",
  "Prev": "",
  "Preview": "",
  "Price": "",
  ...
  "Request id:": "",
  "Request Pairing": "",
  "Request signer keys from store users": "",
  "Request signer keys, collect account keys, and create the multisig wallet": "",
  "Requests": "",
  "Requests may be paid in partial. They will remain valid until time expires or when paid what is due.": "",
  "Required Field": "",
  "Required signatures (M)": "",
  "Required signatures must be between 1 and total signers (N).": "",
  "Rescan Wallet": "",
  ...
  "Schedule update": "",
  "Schedule upgrade for when the dependencies have been met to ensure a smooth update": "",
  ...
  "Select": "",
  "Select a plugin in the directory to inspect the BTCPay Server state, compatibility checks, and available actions.": "",
  ...
  "Select default plan": "",
  "Select exactly {0} signers for this request. Missing {1} signer(s).": "",
  "Select existing offering": "",
  "Select how you want to provide your multisig signer key.": "",
  "Select labels": "",
  "Select offering": "",
  "Select plan": "",
  "Select store": "",
  ...
  "Select the store users who should provide signer keys for this multisig wallet.": "",
  ...
  "Server": "",
  "Server and account settings moved to the top-right menu, just look up!": "",
  "Server Emails": "",
  "Server IPN": "",
  "Server Name": "",
  "Server Settings": "",
  ...
  "Show update info": "",
  "Showing {0} – {1} of {2}": "",
  "Should you experience issues with a plugin, please provide feedback or report concerns directly to the respective plugin developers.": "",
  "Showing {0} of {1}": "",
  "Sign": "",
  "Sign in": "",
  ...
  "Store Overview": "",
  "Store Quota": "",
  "Store quota must be 0 or greater.": "",
  ...
  "The multisig request was not found or has expired.": "",
  ...
  "The passkey was removed successfully.": "",
  ...
  "The security device could not be registered. ({0})": "",
  ...
  "The translation <b>{0}</b> will be removed from this server.": "",
  ...
  "The user <strong>{0}</strong> will be disabled. Are you sure?": "",
  "The user <strong>{0}</strong> will be enabled. Are you sure?": "",
  "The user <strong>{0}</strong> will be permanently deleted. Are you sure?": "",
  ...
  "This plugin is already installed on the server.": "",
  ...
  "To use this translation's fallback, you can:": "",
  ...
  "total signers": "",
  "Total signers (N)": "",
  "Total signers must be between 1 and 15.": "",
  "Track signer key collection and finalize setup once all keys are submitted.": "",
  "Transaction": "",
  ...
  "Type": "",
  "Type to search": "",
  "Unable to create refund. Check the subscriber's credit balance.": "",
  "Unable to create the replacement transaction ({0})": "",
  "Unable to proceed: As the user <strong>{0}</strong> is the last enabled admin, it cannot be disabled.": "",
  "Unable to proceed: As the user <strong>{0}</strong> is the last enabled admin, it cannot be removed.": "",
  "Unapprove": "",
  "Unapprove user": "",
  "Unarchive": "",
  "Unarchive this app": "",
  ...
  "Use your hardware wallet to auto-fill account key, fingerprint, and key path.": "",
  "Used ({0})": "",
  "Used Permissions": "",
  "User": "",
  "User approved": "",
  ...
  "via the REST API": "",
  "Version": "",
  "Version {0} is available. Manage updates from Installed Plugins.": "",
  "Version {0} is disabled on this server.": "",
  "View": "",
  "We recommend users exercise caution and conduct their own research or consult the community before installing any plugin.": "",
  "View All": "",
  "View all": "",
  "View all supporters": "",
  "View Invite": "",
  ...
  "View seed": "",
  "View status": "",
  "View the public node info": "",
  "View transactions": "",
  "View Usage": "",
  "Waiting for {0} signers": "",
  ...
  "What is a passkey?": "",
  "When enabled, prices entered in the keypad are tax inclusive.": "",
  "When enabled, this user will not be required to have an active subscription.": "",
  ...
  "You have reached the maximum number of stores allowed ({0}).": "",
  ...
  "Your account will no longer have the passkey <strong>{0}</strong> as an option for passwordless login.": "",
  ...
  "Your account will no longer have this passkey as an option for passwordless login.": "",

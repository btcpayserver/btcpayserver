...
"""
{
  ...
  "Legacy API Keys": "",
  "Legacy mode is enabled for the Available Plugins section.": "",
  "Less than": "",
  "Let's get started": "",
  "Light": "",
  "Lightning": "",
  ...
  "Search transactions...": "",
  "Search…": "",
  "Search currently uses the legacy BTCPay Server list for Available Plugins while the embedded directory does not expose the same search behavior yet.": "",
  "seconds": "",
  ...
  "The embedded plugin directory did not respond, so BTCPay Server switched back to the legacy Available Plugins list.": "",

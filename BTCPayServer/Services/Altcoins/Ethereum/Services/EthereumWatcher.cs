...
namespace BTCPayServer.Services.Altcoins.Ethereum.Services
{
    public class EthereumWatcher : EventHostedServiceBase
    {
            ...
            if (evt is CatchUp)
            {
                ...
                Task.Run(() =>
                {
                    ...
                    while (true)
                    {
                        try
                        {
                            UpdateAnyPendingEthLikePaymentAndAddressWatchList(cancellationToken);
        ...
        public class EthereumAddressBalanceFetched
        {
            ...
            public override string ToString()
            {
                return $"EthereumAddressBalanceFetched: Address:{Address} Amount:{Amount} Invoice:{InvoiceEntity.Id}";            
            }
        }

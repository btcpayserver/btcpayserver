...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            foreach (var info in this.GetPaymentPrompts())
            {
                ...
                cryptoInfo.PaymentType = info.PaymentMethodId.PaymentType.ToString();
        ...
        {
            return new PaymentMethodId(currency, PaymentTypes.BTCLike) == paymentId ? currency : paymentId.ToString();
        }
#nullable enable
        ...
        public PaymentPrompt? GetPaymentPrompt(BTCPayNetworkBase network, PaymentType paymentType)
        {
            return GetPaymentPrompt(new PaymentMethodId(network.CryptoCode, paymentType));
        }

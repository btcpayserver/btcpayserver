...
namespace BTCPayServer.Services.Wallets
{
    ...
    public class BTCPayWallet
    {
        ...
        public async Task<(BitcoinAddress, KeyPathInformation)> ReserveAddressAsync(DerivationStrategyBase derivationStrategy)
        {
            ...
            return (pathInfo.ScriptPubKey.GetDestinationAddress(Network.NBitcoinNetwork), pathInfo);
        }

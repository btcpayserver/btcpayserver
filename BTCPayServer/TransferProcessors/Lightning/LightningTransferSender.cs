...
public class LightningTransferSender : BaseTransferSender<AutomatedTransferBlob>
{
    ...
    public LightningTransferSender(
        BTCPayNetworkJsonSerializerSettings btcPayNetworkJsonSerializerSettings,
        LightningClientFactoryService lightningClientFactoryService,
        IEnumerable<IPayoutHandler> payoutHandlers,
        UserService userService,
        ILoggerFactory logger, IOptions<LightningNetworkOptions> options,
        StoreRepository storeRepository, TransferProcessorData transferProcesserSettings,
            ...
            btcPayNetworkProvider)
    {
        ...
        _network = _btcPayNetworkProvider.GetNetwork<BTCPayNetwork>(TransferProcesserSettings.GetPaymentMethodId().CryptoCode);
    }
    ...
    protected override async Task Process(ISupportedPaymentMethod paymentMethod, PayoutData[] payouts)
    {
        ...
        if (lightningSupportedPaymentMethod.IsInternalNode &&
            !(await Task.WhenAll((await _storeRepository.GetStoreUsers(TransferProcesserSettings.StoreId))

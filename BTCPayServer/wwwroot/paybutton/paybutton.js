...
function inputChanges(event, buttonSize) {
    ...
    var html =
        ...
        // Form
        '<form method="POST" '+ ( srvModel.useModal? ' ' : '' )+' id="btcpay-paybutton-form" action="' + esc(srvModel.urlRoot) + actionUrl + '" class="btcpay-form btcpay-form--' + (srvModel.fitButtonInline ? 'inline' : 'block') +'">\n' +

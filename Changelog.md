...
* Fix a crash on coin selection if we weren't able to guess the color of a label. @Kukks
...
* Checkout: Fix modal iframe clipboard permissions (#4453) @dennisreimann
* Checkout: Add persian language back (#4457)
* Make sure payment request print view doesn't show table header twice (#4447) @bolatovumar


### Improvement

* Make checkout CSS and logo paths relative when possible (#4195 #4354) @bolatovumar
* Frontend cleanups (#4449) @dennisreimann
